...
// 	App.FileSystem := afero.NewMemMapFs()
// 	App.FileSystem.MkdirAll("templates/testbundle/pages", 0755)
// 	App.FileSystem.MkdirAll("templates/mytemplates/pages", 0755)
...
// 	afero.WriteFile(App.FileSystem, "templates/mytemplates", []byte("default template"), 0644)
